...
data class Producto(val nombre: String, val marca:String, val categoria:Int,val precio: Float, val cantidad: Int)



fun cargar(productos: MutableMap<Int, Producto>) {
    productos[10] = Producto("Galaxi Z flip", "Samsung",2,24999.99f, 20)
